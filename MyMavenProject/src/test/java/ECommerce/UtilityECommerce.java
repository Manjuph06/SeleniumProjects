...
public class UtilityECommerce {
	...
	public List <WebElement> viewCart() throws InterruptedException {
		driver.findElement(By.linkText("Cart")).click();
		Thread.sleep(2000);

		//list of products to be deleted and its links
		List <WebElement> deletelinks= driver.findElements(By.xpath("//*[@id=\"tbodyid\"]/tr/td[4]/a")); 

		return deletelinks ;
	}

	public void deleteFromCart(List <WebElement> links) throws InterruptedException {
